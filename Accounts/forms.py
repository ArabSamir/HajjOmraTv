...
class ContactUsForm (forms.Form):
	name = forms.CharField(label= 'الإسم' ,widget=forms.TextInput(attrs={'class': 'form-control text-right','placeholder': 'الإسم',}), required = True)
	phone = forms.CharField(label= 'الهاتف' ,widget=forms.TextInput(attrs={'class': 'form-control text-right','placeholder': 'الهاتف',}), required = True)
	email = forms.EmailField(label= 'البريد الإلكتروني' ,widget=forms.EmailInput(attrs={'class': 'form-control text-right','placeholder': 'البريد الإلكتروني',}), required = True)
	comments = forms.CharField(label= 'التعليق' ,widget=forms.Textarea(attrs={'class': 'form-control text-right','placeholder': 'يرجى وصف ما تحتاجه',}), required = True)
