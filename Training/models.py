...
class UserTraining(models.Model):
	user = models.ForeignKey(User , on_delete=models.SET_NULL,verbose_name=_('المستخدم'),blank=True,null=True)
	training = models.ForeignKey(Training , on_delete=models.SET_NULL,verbose_name=_('الدورة'),blank=True,null=True)
